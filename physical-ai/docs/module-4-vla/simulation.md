...
class IsaacVLASimulation:
    ...
    def configure_physics_settings(self):
        ...
        physics_ctx.set_gravity(np.array(self.simulation_config['gravity']))
        physics_ctx.set_fixed_timestep(self.simulation_config['physics_dt'])
        physics_ctx.set_max_substeps(self.simulation_config['max_substeps'])
        physics_ctx.set_solver_type(self.simulation_config['solver_type'])
